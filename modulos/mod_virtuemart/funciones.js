...
function nuevosEnTpv() {
  ...
  $.ajax({
    ...
    beforeSend: function () {
      console.log(
        "*********  entre en ccontar nuevos en tpv  ****************"
      );
    },
    success: function (response) {
...
function nuevosEnWeb() {
  ...
  $.ajax({
    ...
    beforeSend: function () {
      console.log(
        "*********  entre en ccontar nuevos en web  ****************"
      );
    },
    success: function (response) {
      ...
      console.log(resultado);
      total =
        parseInt(regWeb) - parseInt(resultado["productos"][0]["cantArticulo"]);
      $("#DivOpciones").show();
    },
  });
}
...
function modificarProductosTpvWeb(
  nombre,
  refTienda,
  iva,
  precioSiva,
...
function obtenerProductosRelacionados() {
  ...
  $.ajax({
    ...
    beforeSend: function () {
      console.log(
        "*********  Obtener los datos de la tabla articuloTienda ****************"
      );
    },
    success: function (response) {
...
function cicloCamposPersonalizado() {
  ...
  $.ajax({
    ...
    beforeSend: function () {
      console.log(
        "*********  Obtener idVirtuemar del producto ****************"
      );
    },
    success: function (response) {
...
function AnhadimosCamposVirtuemart(idVirtuemart) {
  ...
  if ((totaProductoPeso) => reg_inicial) {
    ...
    $.ajax({
      ...
      beforeSend: function () {
        console.log(
          "*********  Añadir campos personalizadso de peso a los productos ****************"
        );
      },
      success: function (response) {
