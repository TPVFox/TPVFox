 ...
 * @author alagoro
 */
class alArticulosRegularizacion extends ModeloP
{ // hereda de clase modelo.
    ...
    {
        return alArticulosRegularizacion::_leer(self::$tabla, [
    ...
    public static function leerTodos($condiciones, $columnas = [], $limit = 0, $offset = 0)
    {
        ...
        return parent::_leer(
            ...
            $condiciones,
            $columnas,
            ['articulos as arts ON(regu.idArticulo = arts.idArticulo)'],
            $limit,
            $offset
        );
    }
    ...
    {
        $resultado = alArticulosRegularizacion::_leer(self::$tabla, [
            'idArticulo =' . $idArticulo,
            ' idTienda = ' . $idTienda
        ], ['COUNT(idArticulo) AS contador'], 1);
