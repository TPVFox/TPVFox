...
class ClaseProductos extends ClaseTablaArticulos
{
    ...
    public function AnhadirProductoNuevo($datos)
    {
        ...
        if (!isset($respuesta['error'])) {
            ...
            $comprobaciones['insert_articulos'] = array(
                'id_producto_nuevo' => $respuesta['idInsert'],
    ...
    public function ComprobarEliminar($id, $idTienda)
    {
        ...
        $sql[8] = [
            'select count(idArticulo) as cant from articulosTiendas where idArticulo=' . $id . ' and idTienda=' . $idTienda,
