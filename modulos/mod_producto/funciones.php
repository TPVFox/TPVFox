...
function guardarDatosUnidades($datosArray, $datosArrayEs, $format)
{
    ...
    $datosMesesUnidades = array(
        number_format($datosArray['entrega'], $format, '.', ''),
        number_format($datosArray['salida'], $format, '.', ''),
        number_format($datosArray['stock'], $format, '.', '')
    );
    $datosMesesUnidades2 = array(
        number_format($datosArrayEs['entrega'], $format, '.', ''),
        number_format($datosArrayEs['salida'], $format, '.', ''),
        number_format($datosArrayEs['stockEs'], $format, '.', '')
    );
    $datosMesesUnidades3 = array(
        number_format($datosArray['entradaSinEs'], $format, '.', ''),
        number_format($datosArray['salidaSinEs'], $format, '.', ''),
        number_format($datosArray['stockSinEs'], $format, '.', '')
    );
...
function guardarDatosImportes($datosArray, $datosArrayEs, $format)
{
    ...
    $datosMesesUnidades = array(
        number_format($datosArray['compras'], $format, '.', ''),
        number_format($datosArray['ventas'], $format, '.', ''),
        number_format($datosArray['beneficio'], $format, '.', '')
    );
    $datosMesesUnidades2 = array(
        number_format($datosArrayEs['entrega'], $format, '.', ''),
        number_format($datosArrayEs['ventas'], $format, '.', ''),
        number_format($datosArrayEs['beneficioEs'], $format, '.', '')
    );
    $datosMesesUnidades3 = array(
        number_format($datosArray['comprasSinEs'], $format, '.', ''),
        number_format($datosArray['ventasSinEs'], $format, '.', ''),
        number_format($datosArray['beneficioSinEs'], $format, '.', '')
    );
...
function sumar_reduce($result, $item)
{
