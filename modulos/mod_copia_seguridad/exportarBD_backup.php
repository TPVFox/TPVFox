<?php 
/**
 * Este archivo contiene la clase Backup_Database que realiza
 * una copia de seguridad parcial o completa de cualquier base de datos MySQL dada
...
//define("TABLES", 'indices, usuarios, tiendas'); // Copia de seguridad parcial
define("CHARSET", 'utf8');
