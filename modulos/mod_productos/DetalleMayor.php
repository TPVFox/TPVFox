...
$ruta_volver = $HostNombre . '/modulos/mod_productos/ListaProductos.php';
...
if (isset($_GET['idArticulo'])) {
    ...
    // Nota: Normalmente venimos de vista ListaProductos y este nos envia Fecha Inicio y Fecha Final
...
<body>
    ...
    <div class="container">
        ...
        <div id="error"><?php if ($activarMensaje) {
                            echo $mensaje;
                        } ?></div>
