...
class ConfigImportar
{
  ...
  public $reg_log = array(
    'importar' => array(
      'nulo'  => 'Si', // Mostramos codigos nulos, si tenmos un campo Nulo ,sino no habra
      'error' => 'Si', // Mostramos codigos errores
      'sql'   => 'No'  // Sql generamos que produce error
    ),
    'fusionar' => array(
      'Codigo_y_estado' => 'Si', // Mostramos CODIGO y estados dos array
