	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo $HostNombre;?>"><img src="<?php echo $HostNombre;?>/css/img/LogotipoTpvFox.png" alt="TPVFox"></a>
			</div>
				...
				<ul class="nav navbar-nav navbar-left ">
                    ...
                    foreach ($xml->item_nivel_1 as $nivel1){
                        ...
                        if ($tipo == 'vista'){
                            ...
                            // Si es modulo, debemos comprobar si tiene permisos,tb
