...
if (isset($dispositivos) && is_array($dispositivos) && count($dispositivos) > 0) {
    ...
    foreach ($dispositivos as $dispositivo) {
        ...
        if (isset($ClasePermisos) && $ClasePermisos->getAccion("modificarDispositivo", $mod_vista)):
            echo "<td><a class='btn btn-sm btn-primary' href='./temperaturasListado.php?id=" . $id . "&modo=media'>Ver</a><a class='btn btn-sm btn-default' href='./temperatura.php?edit=" . $id . "'>Editar</a>";
