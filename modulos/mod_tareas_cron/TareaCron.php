    ...
    <div class="container">
        ...
        <form action="TareaCron.php?accion=guardar" method="POST" name="formTareaCron">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    Activo <input type="radio" name="estado" id="estado-activo" value="1" <?php if ($CTareasCron->tareaCron['estado'] == MTareasCron::ESTADO_ACTIVO) {
                                                                                                echo 'checked';
                                                                                            } ?>>
                    Baja <input type="radio" name="estado" id="estado-baja" value="0" <?php if ($CTareasCron->tareaCron['estado'] == MTareasCron::ESTADO_BAJA) {
                                                                                            echo 'checked';
                                                                                        } ?>>
                </div>
            </div>
