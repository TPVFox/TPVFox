                    ...
                    ?>
                        ...
                        <div class="collapse mt-3" id="configAvanzada">
                            <div class="card card-body">
                                ...
                                <div class="form-group ipPcGroup">
                                    <label for="serieH">¿La balanza es de la serie H?</label>
                                    <select class="form-control ipPcGroup" id="serieH" name="serieH">
                                ...
                                <div class="form-group ipPcGroup">
                                    <label for="serieTipo">¿La balanza es de la serie A, L o L tickets?</label>
