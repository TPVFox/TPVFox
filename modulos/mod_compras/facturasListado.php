...
$listado = $CFac->TodosFacturaLimite($filtro . $NPaginado->GetLimitConsulta(), $filtroParams);
                        ...
                        ?>
                            <tr>
                                ...
                                if ($factura['estado'] !== "Sin Guardar") {
                                    $linkImprimir = ' <a title="Imprimir factura" style="cursor:pointer" class="glyphicon glyphicon-print" ' .
