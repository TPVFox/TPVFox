<?php 
//@ Objetivo:
//Añade un albaran temporal se guarda en temporal cada vez que haga un cambio por Ajax
//es igual que la de pedidos pero esta vez en la tabla temporal de albaranes
