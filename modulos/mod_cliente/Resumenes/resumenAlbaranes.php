        ...
        if (count($_POST) > 0){
            // Ya se envio post
            $redirect ='Location: resumenAlbaranes.php?hacerResumen=Si&id='.$id; 
        ...
        if(isset($_GET['hacerResumen'])){
            ...
            $arrayNums=$Cliente->albaranClienteFechas($id, $fechaInicial, $fechaFinal);
        ...
        <div class="container">
            ...
            <div class="col-md-12" >
                <div class="col-md-3 " >
                    ...
                    <a class="btn btn-primary" onclick="imprimirResumen('Albaranes', '<?php echo $id; ?>', '<?php echo $fechaInicial;?>', '<?php echo $fechaFinal;?>')">Imprimir resumen</a>
