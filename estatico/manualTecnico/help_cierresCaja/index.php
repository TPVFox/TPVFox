	...
	<div class="col-md-6">
		...
		<ul>
			...
			<p>Si se hace de la mañana es posible que salgan 2 usuarios, y si el que hace el cierre no tiene tickets abiertos,
				...
				Y no puede acceder al ticket de su compañero para poder hacer cierre de caja. </br><strong>Tendra que avisar al administrador para hacer cierre caja.</strong>
			</p>
		</ul>
