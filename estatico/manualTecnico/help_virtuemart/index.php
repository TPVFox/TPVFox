<div>
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-12">
            ...
            <ul>
                <li>Acciones a realizar NUEVOS/MODIFICADOS y COMPROBACIONES
                    <ul>
                        <li><b>Importamos codbarras:</b>
                            ...
                            <br />-Ignorar: No se tiene encuenta tanto para añadir ,como para modificar.. y tampoco se tiene en cuenta a la hora comprobar diferencias.
                        </li>
