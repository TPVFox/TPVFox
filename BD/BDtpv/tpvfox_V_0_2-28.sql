...
-- Tiempo de generación: 28-05-2021 a las 00:20:58
-- Versión del servidor: 10.3.27-MariaDB-0+deb10u1
-- Versión de PHP: 7.3.27-9+0~20210223.81+debian10~1.gbpa4a3d6
...
(1, 'Sin identificar', 'Sin identificar', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'activo', NULL, '2021-05-28 00:20:04');
...
(1, 'admin', 'ea6b2efbdd4255a9f1b3bbc6399b58f4', '2021-05-28', 9, 'activo', 'admin');
