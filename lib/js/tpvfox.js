/* Este fichero es una version global.js que esta el directori controllers, que debemos eliminar de ahí.
 * En este fichero tendremos las fucions JS que debemos cargar en todas las paginas
 * La funciones deben ser standars se nombran TFNombreFuncion para evitar problemas con otras que puedan utilizar mismo nombre.
 *
 * */
...
function TfObtenerCheck(clase) {
    ...
    var checks = [];
    ChecksObj =TfObtenerObjetos(clase);
