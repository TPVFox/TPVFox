...
class PluginClaseVirtuemart extends ClaseConexion{
    ...
    public function __construct($dedonde ='') {
        ...
        if (isset($tiendasWebs['items'])){
            ...
            // Realmente pienso que no debe cortar el acceso al modulo, ya que hace otras cosas aparte reorganizar la web
            //~ echo '<pre>';
            //~ print_r('Error NO HAY Empresa tipo web');
            //~ echo '</pre>';
            //~ exit();
        }
    }
