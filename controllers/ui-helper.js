...
document.addEventListener("DOMContentLoaded", function () {
  document.querySelectorAll("[data-toggle-panel]").forEach(function (btn) {
    btn.addEventListener("click", function () {
      ...
      var otherCollapseClass =
        this.getAttribute("data-other-collapse-class") || "";
      ...
      if (isHidden) {
        ...
        if (expandClass) {
          ...
          console.log(
            "[ui-helper] Clase expandida aplicada a",
            targetId,
            ":",
            expandClass
          );
        ...
        if (collapseClass) {
          ...
          console.log(
            "[ui-helper] Clase colapsada aplicada a",
            targetId,
            ":",
            collapseClass
          );
...
$(document).on("click", ".toggle-filtros", function () {
  ...
  if ($filtros.is(":hidden")) {
    ...
    console.log(
      "Filtros ocultos, limpiando inputs y mostrando todas las filas"
    );
  }
});
