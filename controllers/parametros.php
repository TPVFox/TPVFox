...
class ClaseParametros 
{
    ...
    private $rutaFichero; // Ruta del fichero principal para guardar
    ...
    public function getNode($xpath){
        // @ Objetivo: Obtener un nodo específico del XML
        // @ Parametros:
        //   $xpath -> string con la ruta xpath del nodo
        // @ Devuelve: objeto SimpleXMLElement o null
    ...
    public function setNodeValue($xpath, $valor){
        // @ Objetivo: Establecer el valor de un nodo
        // @ Parametros:
        //   $xpath -> string con la ruta xpath del nodo
        //   $valor -> string con el nuevo valor
    ...
    public function setNodeAttribute($xpath, $atributo, $valor){
        // @ Objetivo: Establecer el valor de un atributo de un nodo
        // @ Parametros:
        //   $xpath -> string con la ruta xpath del nodo
        //   $atributo -> string con el nombre del atributo
        //   $valor -> string con el nuevo valor del atributo
        $nodos = $this->root->xpath($xpath);
        if (!empty($nodos)) {
    ...
    public function save($fichero = ''){
        // @ Objetivo: Guardar los cambios en el fichero XML
        // @ Parametros:
        //   $fichero -> string (opcional) ruta del fichero donde guardar
        // @ Devuelve: boolean indicando éxito
        if ($fichero === '') {
            $fichero = $this->rutaFichero;
        }
