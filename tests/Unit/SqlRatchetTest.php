 ...
 *
 * Cuenta las llamadas crudas `->query(` que quedan en modulos/ y clases/ (SQL a
 * mano, potencialmente inyectable). El número NO puede crecer: el código nuevo
